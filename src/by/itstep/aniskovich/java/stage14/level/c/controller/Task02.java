...
import by.itstep.aniskovich.java.stage14.level.c.util.ArrayCountIndexOverAvgGeomUI;
...
public class Task02 {
    public static void main(String[] args) {
        ...
        ConsolePrinter.print(ArrayCountIndexOverAvgGeomUI.format
                (Array.countIndexOverAvgGeom(array),
                        Array.avgGeomIndexArray(array)));
