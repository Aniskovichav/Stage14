...
import by.itstep.aniskovich.java.stage14.level.b.util.ArrayCountIndexEqualNumUI;
...
public class Task03 {
    public static void main(String[] args) {
        ...
        ConsolePrinter.print(ArrayCountIndexEqualNumUI.format
                (Array.countIndexEqualNum(array, number), number));
    }
}
