...
import by.itstep.aniskovich.java.stage14.level.b.util.ArrayCountIndexUnequalNumUI;
...
public class Task04 {
    public static void main(String[] args) {
        ...
        ConsolePrinter.print(ArrayCountIndexUnequalNumUI.format
                (Array.countIndexUnequalNum(array, number), number));
    }
}
